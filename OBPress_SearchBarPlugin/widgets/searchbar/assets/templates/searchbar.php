<form type="POST" action="https://book.omnibees.com/chainresults">
    <div class="ob-searchbar container" id="index" data-hotel-folders="<?php echo htmlspecialchars(json_encode($hotelFolders), ENT_QUOTES, 'UTF-8'); ?>">
                        ...
                        <div class="select-guests-holder">
                            ...
                            <div class="select-child-ages-holder">
                                <div class="select-child-ages-clone">
                                    <p class="select-child-ages-title custom-text"><?php _e('Children', 'obpress'); ?> <span class="select-child-ages-number"></span></p>
                                    <select class="select-child-ages-input-clone">
                                        <?php for ($i = 0; $i < 18; $i++) : ?>
                                            <option data-value="<?= $i; ?>"><?= $i; ?> <?php _e('Years', 'obpress'); ?></option>
                                        <?php endfor; ?>
                                    </select>
    ...
    <div class="zcalendar-wrap">
			<div class="zcalendar" data-promotional="<?php _e('Offers for you', 'obpress'); ?>" data-promo="<?php _e('Special Offer', 'obpress'); ?>" data-unavilable="<?php _e('*Price for 1 adult / 1 night', 'obpress') ?>" data-lang="{{$lang->Code}}"  data-night="<?php _e('Night', 'obpress') ?>" data-nights="<?php _e('Nights', 'obpress') ?>"></div>
		</div>     
</form>