jQuery(document).ready(function () {
  ...
  hotelFolders = JSON.parse(jQuery(".ob-searchbar").attr("data-hotel-folders"));
  ...
  var hotels_folder_div = jQuery(".hotels_dropdown")
    .find(".hotels_folder")
    .eq(0);
  var hotels_hotel_div = jQuery(".hotels_dropdown").find(".hotels_hotel").eq(0);
  ...
  jQuery("#promo_code_apply").click(function (e) {
    ...
    } else if (jQuery("#Code").val() != null && jQuery("#Code").val() != "") {
  ...
  if (jQuery("#hotel_code").val() != "" && jQuery("#hotel_code").val() != "0") {
    // childrenAllowed();
  ...
  jQuery("#guests").on("click", function () {
    ...
    if (occupancyDropdown.css("display") == "none") {
      ...
      jQuery(this).css(
        "background-image",
        "url(/icons/icons_GreyDark/iconGreyDark_ArrowUp.svg)"
      );
  ...
  jQuery(".hotels_all, .hotels_hotel, .hotels_folder").on("click", function () {
  ...
  jQuery(document).on("click", ".select-child-plus", function () {
    ...
    if (guests[roomCounter].children < 10) {
      ...
      //Appends the child age clone to the div its supposed to be in
      childAge.appendTo(jQuery(".select-child-ages-holder").eq(roomCounter));
  ...
  jQuery(document).on("click", ".select-room-minus", function () {
    var roomCounter = jQuery(".select-room").last().attr("data-room-counter");

    var applyButtonGuests =
      parseInt($(".select-occupancy-apply-info-guests").attr("data-guests")) -
    ...
    var applyButtonRooms =
      parseInt($(".select-occupancy-apply-info-rooms").attr("data-rooms")) - 1;
    jQuery(".select-occupancy-apply-info-rooms").attr(
      "data-rooms",
      applyButtonRooms
    );
  ...
  jQuery(document).on("click", ".select-occupancy-apply", function () {
    ...
    //Set the whole string
    var guestsInputString =
      numberOfRooms + " " + roomString + ", " + guestNumber + " " + guestString;
